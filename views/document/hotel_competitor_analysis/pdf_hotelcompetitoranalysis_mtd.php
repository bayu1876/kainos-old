       ...
       $date =  $tanggal;
        ...
        echo '<table border=1 width="100%" style="font-size: 7pt">
                ...
                <tr>
                    ...
                    echo '
                    <tr>
                        <td colspan="17" style="text-align: left"><b>4 STARS HOTEL ****</b></td>
                    </tr>';
                    }//endif 4stars
                    ...
                    foreach($dt_hotelcomp4->result() AS $rowhtl)
                    {
                        ...
                        <!-- End MPI -->
                        <td class="kolom" style="'.$styletd.'" width="200px">';
                   ...
                   echo '
                   <tr>
                        <td colspan="17" style="text-align: left"><b>3 STARS HOTEL ***</b></td>
                    </tr>';
                    }//endif hotel 3 stars
