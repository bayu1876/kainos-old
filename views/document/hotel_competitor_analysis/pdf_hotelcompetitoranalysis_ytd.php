...
<script type="text/php">
    if ( isset($pdf) ) {
        //$path_image = str_replace(basename($_SERVER['SCRIPT_FILENAME']),"",$_SERVER['SCRIPT_FILENAME'])."images/logo";

        //$pdf->image("$path_image/header_mini.jpg", "jpg", 250,10, 90, 45);
       ...
       $date =  $tanggal;
        ...
        echo '<table border=1 width="100%" style="font-size: 7pt">
                <tr>
                    ...
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>Room Sold</b></td>
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>OCCUPANCY</b></td>
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>ARR</b></td>
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>Total Room Revenue</b></td>
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>Fair Market Share</b></td>
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>Actual Market Share</b></td>
                    <td class="kolom" colspan="2" style="vertical-align: middle; text-align: center"><b>MPI</b></td>
                ...
                <tr>
                    ...
                    echo '
                    <tr>
                        <td colspan="16" style="text-align: left"><b>4 STARS HOTEL ****</b></td>
                    </tr>';
                    }//endif 4stars
                    ...
                    foreach($dt_hotelcomp4->result() AS $rowhtl)
                    {
                        ...
                        $dt_arrmtd = $this->hotel_competitor_analysis_model->select_arrmtdondate_wodateinitbal_perhotel($rowhtl->idhotelcompetitor,$permonth,$peryear,$initbaldate);
                        if($dt_arrmtd != NULL)
                        {
                            $arrmonth = $dt_arrmtd->ARR_MTD;
                        }
                        ...
                        echo '
                        <tr '.$class.'>
                        <td class="kolom" style="'.$styletd.'" width="100px">
                   ...
                   echo '
                   <tr>
                        <td colspan="16" style="text-align: left"><b>3 STARS HOTEL ***</b></td>
                    </tr>';
                    }//endif hotel 3 stars
