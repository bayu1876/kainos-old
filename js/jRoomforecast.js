...
$(document).ready(function(){
    ...
    $('.content-box ul.content-box-tabs li a').click( // When a tab is clicked...
        function() {
            ...
            $.ajax({
                type:"POST",
                url: site_url+"room_forecast/load_roomforecast_currentmonth",
                cache: true,
...
//iwn split page room forecast
    ...
    $('#btnPage1_filter').click(function(){
        $("#page").val(1);
        ...
        $.ajax({
            type:"POST",
            url: site_url+"room_forecast/load_roomforecast_by_monthyear",
    ...
    $('#btnPage2_filter').click(function(){
        $("#page").val(2);
