 ...
 $(document).ready(function(){
    ...
    $('.content-box ul.content-box-tabs li a').click( // When a tab is clicked...
        function() {
            ...
            $.ajax({
                type:"POST",
                url: site_url+"sales/load_sales_group",
                cache: true,
                success: function(data){
                    $("#datasalesgroup").html(data);
                },
                beforeSend: function(){
                    $("#datasalesgroup").html('<img src="'+base_url+'images/loading.gif"/>Loading...');
                }
            });
    ...
    if($("#form_group").validationEngine({returnIsValid:true})){
           $.ajax({
              ...
              success: function(){
                ...
                window.location = site_url +'sales/sales_group';
              },
               beforeSend: function(){
   ...
   $("#form_editgroup").validationEngine();
   $("form#form_editgroup").submit(function(){
    if($("#form_editgroup").validationEngine({returnIsValid:true})){
           $.ajax({
              type:"POST",
              url: site_url+"sales/update_group",
              cache: true,
