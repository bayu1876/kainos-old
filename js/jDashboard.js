...
//Minimize Content Box
    ...
    $.ajax({
        type:"POST",
        url:site_url+"welcome/load_confirmtoday",
        cache: false,
        data:({
            halaman:1
        }),
    ...
    $.ajax({
        type:"POST",
        url:site_url+"welcome/load_canceltoday",
        cache: false,
        data:({
            halaman:1
        }),
    ...
    $("#page_confirm").paginate({
        ...
        onChange  : function(page){
            ...
            $.ajax({
                type:"POST",
                url:site_url+"welcome/paging_confirmtoday",
                cache: false,
                data:({
                    halaman:page
                }),
                ...
                beforeSend: function(){
                     $('#p'+page).html('<img src="'+base_url+'images/WebResource.axd.gif" align="absmiddle">Loading...');
                }
            });
            return false;
        }
...
var totaldatacancel = $('#totaldatacancel').val();
    $("#page_cancel").paginate({
        ...
        onChange  : function(page){
            ...
            $.ajax({
                type:"POST",
                url:site_url+"welcome/paging_canceltoday",
                cache: false,
                data:({
                    halaman:page
                }),
                ...
                beforeSend: function(){
                  $('#pgc'+page).html( '<img src="'+base_url+'images/WebResource.axd.gif" align="absmiddle">Loading...' );
                }
            });
            return false;
        }
