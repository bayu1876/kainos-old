...
$(document).ready(function() {
    ...
    $.ajax({
        type:"POST",
        url:site_url+"welcome/load_confirmtodaypergm",
        cache: false,
        data:({
            halaman:1
        }),
    ...
    $.ajax({
        type:"POST",
        url:site_url+"welcome/load_canceltodaypergm",
        cache: false,
        data:({
            halaman:1
        }),
    ...
    $("#page_cancel").paginate({
        ...
        onChange  : function(page){
            ...
            $.ajax({
                type:"POST",
                url:site_url+"welcome/paging_canceltodaypergm",
                cache: false,
                data:({
                    halaman:page
                }),
    ...
    $("#page_confirm").paginate({
        ...
        onChange  : function(page){
            ...
            $.ajax({
                type:"POST",
                    url:site_url+"welcome/paging_confirmtodaypergm",
                cache: false,
                data:({
                    halaman:page
                }),
