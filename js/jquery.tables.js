...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	$addRowBtn.click(function(){
		if(newRowCount < maxRows){
			...
			//clone the blank row, put the clone at the bottom, set the correct classes, remove the ID, animate the divs inside
			...
			newRow = $("#"+blankRowID,$tableBody).clone().appendTo($tableBody).attr("class",newClasses).removeAttr("id").show().find("td div").slideDown(rowSpeed,function(){
	      ...
	      // if the current input has the hasDatpicker class
	       if($(this).hasClass("hasDatepicker")){
	        ...
	        $(this).datepicker({dateFormat:'dd-mm-yy'}); // re-init datepicker
	      }
