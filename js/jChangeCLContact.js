...
$(document).ready(function(){
      $("#number").autocomplete({
        ...
        source:function(req,add){
            $.ajax({
                url: site_url+ "change_contact/search_CL" ,
                dataType: 'json',
                type:'POST',
                data:req,
        ...
        select: function( event, ui ) {
            ...
            $.ajax({
                url: site_url+ "change_contact/get_detail_CL" ,
                dataType: 'html',
                type:'POST',
                data:({number:number}),
                success:function(data){
 ...
 var idcontact;
    ...
    $("#btnchangecontact").live('click',function(){
        var cl = $("#number").val();
         ...
         $.ajax({
                url: site_url+ "change_contact/submit_contact_CL" ,
                dataType: 'html',
                type:'POST',
                data:({idcontact:idcontact,clnumber:cl}),
                success:function(data){
                    $("#containerdata").html(data);
                } ,
                beforeSend: function(){
